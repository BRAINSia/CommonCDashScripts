...
# steps of ${PROJECT_INTERNAL_NAME}
#
...
if(NOT DEFINED GIT_REPOSITORY)
  message(FATAL_ERROR "Failed GIT_REPOSITORY must be specified")
else()
...
macro(run_ctest)
  ...
  set(build_in_progress_file ${CTEST_BINARY_DIRECTORY}/${PROJECT_INTERNAL_NAME}-build/BUILD_IN_PROGRESS)
...
")
  ...
  if(FILES_UPDATED GREATER 0 OR force_build)
    ...
    if(run_ctest_with_configure)
      ...
      #set(label ${PROJECT_INTERNAL_NAME})
    ...
    #-----------------------------------------------------------------------------
    set(${PROJECT_INTERNAL_NAME}_build_dir "${CTEST_BINARY_DIRECTORY}/${PROJECT_INTERNAL_NAME}-build")
    ...
    if(run_ctest_with_test)
      ...
      ctest_test(
        BUILD "${${PROJECT_INTERNAL_NAME}_build_dir}"
        #INCLUDE_LABEL ${label}
    ...
    if(run_ctest_with_coverage)
      ...
      file(READ ${${PROJECT_INTERNAL_NAME}_build_dir}/CMakeFiles/TargetDirectories.txt ${PROJECT_INTERNAL_NAME}_build_coverage_dirs)
      file(APPEND "${CTEST_BINARY_DIRECTORY}/CMakeFiles/TargetDirectories.txt" "${${PROJECT_INTERNAL_NAME}_build_coverage_dirs}")

      if(WITH_COVERAGE AND CTEST_COVERAGE_COMMAND)
        message("----------- [ Global coverage ] -----------")
        ctest_coverage(BUILD "${${PROJECT_INTERNAL_NAME}_build_dir}")
        if(run_ctest_submit)
    ...
    if(WITH_MEMCHECK AND CTEST_MEMORYCHECK_COMMAND AND run_ctest_with_memcheck)
        ...
        ctest_memcheck(BUILD "${${PROJECT_INTERNAL_NAME}_build_dir}")
        if(run_ctest_submit)
